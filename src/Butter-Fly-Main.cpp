...
int main()
{
    ...
    //a short name for every single particular Image, declaration in "picSources([1-4])", source pictures are in folder <Picture>
    ...
    RectUp r1;RectBottom r2; RectFilled r3(0x0, 0.1, 5);RectFilled r4(0xFCFCFC, 0xFE, -5);RectFilled r5(0x0, 0.1, 5);
    
    Text flowerup(0, 0, "▓◆**★**◆※◆**★**◆※**★**◆※◆**★**◆▓◆**★**◆", HOLD);
    Text flowerbottom(0, 445, "▓◆**★**◆※◆**★**◆※**★**◆※◆**★**◆▓◆**★**◆", HOLD);
//    setcolor(0x0099FF, flowerbottom.img); outtextxy(0, 0, flowerbottom.textstring, flowerbottom.img);
    ...
    l[12].init(29.1, 37.8, &p3); l[13].init(29.1, 31.2, &t7);
    ...
    l[61].init(136.6, 142.0, &t29); l[62].init(141.7, 146.5, &t30); l[63].init(153.2, 155.8, &t31); 
    ...
    l[74].init(163.7, 164.1, &iz1); l[75].init(164.2, 164.6, &iz2); l[76].init(164.7, 165.1, &iz3); 
